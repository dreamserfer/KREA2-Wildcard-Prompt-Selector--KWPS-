...
Multiple wildcards can be selected at one time and selections can be cleared easily.

since it only modifies the prompt this node can use in virtually every type of workflow by connecting it to the positive prompt field
